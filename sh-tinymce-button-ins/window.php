...
<script language="javascript" type="text/javascript" src="<?php echo $shtb_ins_url; ?>tinymce.js?ver=0.7"></script>
<script language="javascript" type="text/javascript" src="<?php echo $shtb_ins_url; ?>re_write.js?ver=0.7"></script>
<base target="_self" />
</head>
